...
```javascript
iterPeriodicSinc = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/simulate-iter-periodic-sinc@v0.2.1-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/simulate-iter-periodic-sinc/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/simulate-iter-periodic-sinc/actions/workflows/test.yml?query=branch:v0.2.1
