...
```javascript
iterPeriodicSinc = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/simulate-iter-periodic-sinc@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/simulate-iter-periodic-sinc@umd/bundle.js"></script>
```
